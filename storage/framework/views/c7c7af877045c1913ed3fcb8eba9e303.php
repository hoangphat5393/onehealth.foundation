...
<footer class="main-footer">
    <strong>
        Copyright &copy; 2024 <a href="<?php echo e(route('index')); ?>"><?php echo e(\App\Libraries\Helpers::get_option_minhnn('site-name')); ?></a>.
    </strong>
...
<!-- ./wrapper -->
<?php /**PATH F:\web\onehealth.foundation\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>