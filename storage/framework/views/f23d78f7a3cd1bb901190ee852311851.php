<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <textarea id="seo_description" name="seo_description" class="form-control" rows="4"><?php echo e($seo_description ?? ''); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php /**PATH F:\web\onehealth.foundation\resources\views/admin/form-seo/seo.blade.php ENDPATH**/ ?>