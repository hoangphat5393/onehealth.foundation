            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="my-5">
                            <?php echo htmlspecialchars_decode($category->description); ?>
...
<?php echo $__env->make('theme.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\web\onehealth.foundation\resources\views/theme/news/category.blade.php ENDPATH**/ ?>