                ...
                <div class="row">
                    <div class="col-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php if($sid): ?>
                                    <p class="mb-3">Shortcode: <span style="background: #f1f1f1; display: inline-block; padding: 3px">[slider id="<?php echo e($sid); ?>" items="4"]</span></p>
                                <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sort" name="sort" placeholder="Thứ tự" value="<?php echo e($sort); ?>">
                                </div>
