                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-10">
                                ...
                                {{-- <div class="col-sm-12 mb-3">
                                    <div class="form-floating form-floating-custom icon">
                                        <img class="form-icon" src="{{ asset($templateFile . '/images/user-icon.png') }}" alt="Street Address">
                                        <input type="text" class="form-control form-control-custom" id="address" name="address" placeholder="Street Address" value="{{ $address ?? '' }}">
                                        <label for="address" class="float-label-custom">Street Address</label>
                                    </div>
                                </div> --}}

                                <div class="row register-form-add" style="display: none;">
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-custom icon">
                                            <img class="form-icon" src="{{ asset($templateFile . '/images/lock-icon.png') }}" alt="Phone">
                                            <input type="password" class="form-control form-control-custom" id="password" name="password" placeholder="Password" value="{{ $password ?? '' }}" disabled>
                                            <label for="password" class="float-label-custom">Password</label>
                                        </div>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-custom icon">
                                            <img class="form-icon" src="{{ asset($templateFile . '/images/lock-icon.png') }}" alt="Phone">
                                            <input type="password" class="form-control form-control-custom" id="password_confirmation" name="password_confirmation" placeholder="Re-type password" value="{{ $password_confirmation ?? '' }}" disabled>
                                            <label for="password_confirmation" class="float-label-custom">Re-type password</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row register-form-auto" style="display: none;">
                                    <div class="col-12 mb-3">
                                        <div class="form-floating form-floating-custom icon">
                                            <img class="form-icon" src="{{ asset($templateFile . '/images/lock-icon.png') }}" alt="Phone">
                                            <input type="password" class="form-control form-control-custom" id="password_auto" name="password_auto" placeholder="Password" value="{{ $password_auto ?? '' }}" disabled>
                                            <label for="password_auto" class="float-label-custom">Password</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
