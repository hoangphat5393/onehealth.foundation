                            ...
                            @foreach ($project as $item)
                                <div class="row project mb-4 g-0">
                                    <div class="col-lg-6 align-items-stretch project__content order-2">
                                        <div class="content p-3 bg-white d-flex flex-column">
                                            <h4><a href="{{ route('campaign.detail', [$item->slug, $item->id]) }}" class="text-main">{{ $item->name }}</a></h4>
                                            <div>
                                                {!! htmlspecialchars_decode($item->description) !!}
                                            </div>
                                            <div class="mt-auto ms-auto">
                                                <a class="btn btn-custom me-2" href="{{ route('campaign.detail', [$item->slug, $item->id]) }}" role="button">
                                                    Đọc thêm
                                                </a>
                                    ...
                                    <div class="col-lg-6 order-lg-2">
                                        <div class="item-product">
                                            <a href="{{ route('campaign.detail', [$item->slug, $item->id]) }}" title="{{ $item->name }}">
