                                                ...
                                                <ul class="outer-border">
                                                    ...
                                                    <li class="control-section accordion-section add-page" id="add-page">
                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    @include('admin.setting.includes.page_items')
                                                                </div>
                                                                <p class="button-controls">
                                                    ...
                                                    <li class="control-section accordion-section add-page" id="add-page">
                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    @include('admin.setting.includes.category_items', ['type' => 'post'])
                                                                </div>
                                                                <p class="button-controls">
                                                                    <a href="#" class="button-secondary submit-add-to-menu right add_custommenu">Add menu item</a>
                                                                    <span class="spinner" id="spincustomu"></span>
                                                    ...
                                                    <li class="control-section accordion-section add-page" id="add-page">
                                                        ...
                                                        <div class="accordion-section-content ">
                                                            <div class="inside">
                                                                <div class="customlinkdiv" id="customlinkdiv">
                                                                    @include('admin.setting.includes.category_items', ['type' => 'book'])
                                                                </div>
                                                                <p class="button-controls">
                                                                    <a href="#" class="button-secondary submit-add-to-menu right add_custommenu">Add menu item</a>
                                                                    <span class="spinner" id="spincustomu"></span>
                                                ...
                                                <div id="nav-menu-header">
                                                    <div class="major-publishing-actions">
                                                        <label class="menu-name-label howto open-label" for="menu-name"> <span>Name</span>
                                                            ...
                                                            <input type="hidden" id="idmenu" value="@if ($indmenu) {{ $indmenu->id }} @endif" />
                                                        </label>
                                                                    ...
                                                                    <li id="menu-item-{{ $m->id }}" class="menu-item menu-item-depth-{{ $m->depth }} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
                                                                                ...
                                                                                <span class="item-controls">
                                                                                    ...
                                                                                    <span class="item-order hide-if-js">
                                                                                        <a href="{{ $currentUrl }}?action=move-up-menu-item&menu-item={{ $m->id }}&_wpnonce=8b3eb7ac44" class="item-move-up">
                                                                                            ...
                                                                                            <abbr title="Move Down">↓</abbr></a> </span> <a class="item-edit" id="edit-{{ $m->id }}" title=" "
                                                                        ...
                                                                        <div class="menu-item-settings" id="menu-item-settings-{{ $m->id }}">
                                                                            ...
                                                                            {{-- <p class="field-css-classes description description-thin">
                                                                                <label for="edit-menu-item-classes-{{ $m->id }}" class="col-form-label"> Class CSS (optional)
                                                                                    <br>
                                                                            ...
                                                                            <label for="edit-menu-item-url-{{ $m->id }}" class="col-form-label"> Url
                                                                                <br>
                                                                                <input type="text" id="url_menu_{{ $m->id }}" class="form-control widefat code edit-menu-item-url" id="url_menu_{{ $m->id }}" value="{{ $m->link }}">
                                                                            </label>
                                                                            ...
                                                                            <p class="field-move hide-if-no-js description description-wide">
                                                                                <label> <span>Move</span> <a href="{{ $currentUrl }}" class="menus-move-up" style="display: none;">Move up</a> <a href="{{ $currentUrl }}" class="menus-move-down" title="Mover uno abajo"
                                                                                        style="display: inline;">Move Down</a> <a href="{{ $currentUrl }}" class="menus-move-left" style="display: none;"></a> <a href="{{ $currentUrl }}" class="menus-move-right" style="display: none;"></a>
                                                                            ...
                                                                            <div class="menu-item-actions description-wide submitbox">
                                                                                ...
                                                                                <a class="item-cancel submitcancel hide-if-no-js button-secondary" id="cancel-{{ $m->id }}"
