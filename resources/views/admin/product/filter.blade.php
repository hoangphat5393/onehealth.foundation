                            ...
                            <div class="clear">
                                ...
                                <div class="fr">
                                    <form method="GET" action="{{ route('admin.searchProduct') }}" id="frm-filter-post" class="form-inline">
                                        <?php
                                        $list_cate = App\Models\Category_Theme::orderBy('category_theme.categoryName', 'ASC')
                                            ->select('category_theme.categoryID', 'category_theme.categoryName')
                                            ->get();
                                        ?>
                                        ...
                                        @foreach ($data_product as $data)
                                            <tr>
                                                ...
                                                <td class="text-center" style="width: 250px;">
                                                    <a class="row-title" href="{{ route('admin.productDetail', [$data->id]) }}">
                                                        <b>{{ $data->title }}</b>
                                                        <br>
