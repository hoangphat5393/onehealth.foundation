                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="clear">
                                ...
                                @include('admin.partials.button_add_delete', ['type' => 'service', 'route' => route('admin.serviceCreate')])
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="row-title fw-bold" href="{{ route('admin.serviceEdit', $item->id) }}">
                                                        {{ $item->name }}
                                                    </a>
                                                    {{-- <br>
                                                ...
                                                {{-- <td class="text-center">
                                                    ...
                                                    @foreach ($categories as $k => $category)
                                                        <a class="link" target="_blank" href="{{ route('admin.serviceCategoryEdit', $category->id) }}">{{ $category->name }}</a></br>
                                                    @endforeach
                                                </td> --}}
                                                <td class="text-center">
