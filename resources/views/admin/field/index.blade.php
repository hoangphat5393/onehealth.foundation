...
@section('seo')
    @php
        $title_head = 'Trường nội dung';
        $data_seo = [
            'title' => 'Trường nội dung | ' . Helpers::get_option_minhnn('seo-title-add'),
        ];
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="clear">
                                ...
                                @include('admin.partials.button_add_delete', ['type' => 'field', 'route' => route('admin.fieldCreate')])
                                ...
                                <table class="table table-bordered list-data v-center" id="table_index">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Handle ID</th>
                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="row-title fw-bold" href="{{ route('admin.fieldEdit', $item->id) }}">
                                                        {{ $item->name }}
                                                    </a>
