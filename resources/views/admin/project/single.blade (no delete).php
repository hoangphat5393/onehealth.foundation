...
@php
    ...
    if (isset($project_detail)) {
        $project_detail = $project_detail->toArray();
        extract($project_detail);
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        @php
                                            $province = \App\Model\Province::orderby('name', 'asc')->get();
                                        @endphp
                                    ...
                                    <div class="form-group col-lg-6">
                                        @php
                                            if (isset($province_id) && $province_id != '') {
                                                $district = \App\Model\District::where('province_id', $province_id)
                                                    ->orderby('name', 'asc')
                                                    ->get();
                                            }
                                        @endphp
                                    ...
                                    <div class="form-group col-lg-6">
                                        @php
                                            if (isset($district_id) && $district_id != '') {
                                                $ward = \App\Model\Ward::where('district_id', $district_id)
                                                    ->orderby('name', 'asc')
                                                    ->get();
                                            }
                                        @endphp
                        ...
                        <div class="card widget-category">
                            ...
                            <div class="card-body">
                                <div class="inside clear">
                                    <div class="clear">
                                        @php
                                            $data_checks = isset($post) ? $post->categories->pluck('id')->toArray() : [];
                                            $array_checked = [];
                                            if ($data_checks):
