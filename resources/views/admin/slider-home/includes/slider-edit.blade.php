                    ...
                    <form id="form-editSlider" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="inserIMG">
                                ...
                                @if ($slider->src != '')
                                    <img src="{{ asset($slider->src) }}" id="show-img" class="show-img src-img ckfinder-popup" data-show="show-img" data="src-img" width="200" onerror="this.onerror=null;this.src='{{ asset('images/placeholder.png') }}';">
                                @else
                                    <img src="{{ asset('images/placeholder.png') }}" id="show-img" class="src-img ckfinder-popup" data-show="show-img" data="src-img" width="200">
                                @endif
                                <span class="remove-icon" data-img="{{ asset('images/placeholder.png') }}">X</span>
                            </div>
                        </div>
                        <div class="form-group">
