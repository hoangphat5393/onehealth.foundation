...
class ContactController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.contact.index')->with(['data' => $data_post, 'total_item' => $count_item]);
    }

    public function create()
    {
        return view('admin.contact.single', $this->data);
    }
    ...
    public function post(Request $request)
    {
        ...
        if ($sid > 0) {
            $post_id = $sid;
            $respons = Contact::where("id", $sid)->update($data);
        } else {
