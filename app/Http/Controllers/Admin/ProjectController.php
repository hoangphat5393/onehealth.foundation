...
use App\Models\Project, App\Models\Category, App\Models\Join_Category_Project, App\Models\Project_Join_Variable;
...
class ProjectController extends Controller
{
    ...
    {
        $categories = \App\Models\Join_Category_Project::where('project_id', $id)->get('category_id');
        $category_selected = [];
        foreach ($categories as $key => $item) {
            $category_selected[] = $item->category_id;
        }
        $variables_join = \App\Models\Project_Join_Variable::where('project_id', $id)->get();
        // dd($variables_join);
        $variables_selected = [];
